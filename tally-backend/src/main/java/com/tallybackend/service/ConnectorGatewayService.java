...
public class ConnectorGatewayService {
    ...
    public ResponseEntity<String> forward(HttpMethod method,
                                          ...
                                          String body) {
        try {
            tallyVoucherWriteQueueService.assertVoucherNumberAvailable(method, connectorPath, request, body);
        ...
        } catch (DuplicateVoucherNumberException e) {
            return errorResponse(HttpStatus.CONFLICT,
                    "duplicate_voucher_number",
                    "Voucher number already exists for this company and voucher type.",
                    null,
                    null,
                    e);
    ...
    private ResponseEntity<String> errorResponse(HttpStatus status,
        ...
        return errorResponse(status, detail, reason, connectorBaseUrl, resolutionSource, null);
    }
    ...
    private ResponseEntity<String> errorResponse(HttpStatus status,
                                                 ...
                                                 String connectorBaseUrl,
                                                 String resolutionSource,
                                                 DuplicateVoucherNumberException duplicateVoucherError) {
        ...
        if (duplicateVoucherError != null) {
            payload.put("company", duplicateVoucherError.getCompany());
            payload.put("connector_path", duplicateVoucherError.getConnectorPath());
            payload.put("voucher_number", duplicateVoucherError.getVoucherNumber());
            payload.put("existing_queue_id", duplicateVoucherError.getExistingQueueId());
            payload.put("existing_status", duplicateVoucherError.getExistingStatus());
            payload.put("existing_review_state", duplicateVoucherError.getExistingReviewState());
        }
        try {
